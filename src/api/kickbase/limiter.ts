 ...
 * src/queries/useRefresh.ts). Gebraucht für die Punkte/Min-Kennzahl im Kader-
 * und im Markt-Tab: dort steht ein `/performance`-Request pro Kader-/
 * Marktspieler an, also schnell 20–30 auf einmal.
 *
