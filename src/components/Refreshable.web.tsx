...
/**
 * Web-Plattform: `RefreshControl` ist auf react-native-web ein reines No-op
 * (rendert nur ein leeres `View`, verwirft `onRefresh` — siehe
 ...
 * greift. Diese Komponente baut dieselbe Geste per Touch-Handler nach.
 *
